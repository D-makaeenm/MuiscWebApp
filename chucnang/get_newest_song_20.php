...
$sql = "SELECT TOP 20 id, ms_name, author,time_post, path_to_music, path_to_image, user_post FROM baihat ORDER BY time_post DESC";
...
if ($stmt === false) {
    ...
    while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
        ...
        $song_info = array(
            ...
            'time_post' => $row['time_post']->format('Y-m-d'),
            'path_to_music' => $row['path_to_music']
